# Generated by Django 4.2.2 on 2023-09-06 10:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shot_description', models.CharField(blank=True, max_length=100, verbose_name='Краткое описание')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('add_photo', models.ImageField(blank=True, upload_to='products_image/add/', verbose_name='Фото')),
