...
DEBUG = True
SECRET_KEY = '56343829a92b4f8f275a563a880104bf86053beb'

app = Flask(__name__)
# app.config['SECRET_KEY'] = 'hdshlkgvjndfldfklnljkgngjsdkldsnlks'
...
def index():
    db = get_db()
    dbase = FDataBase(db)
    p = dbase.get_posts_anonce()

    return render_template('attraction.html', title='Главная', menu=dbase.get_menu(), posts=dbase.get_posts_anonce())
